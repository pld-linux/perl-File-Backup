...
Moduł Perla File::Backup stanowi implementację archiwizacji i
kompresji ("backup") oraz rotację archiwów i jest zaimplementowany
poprzez wywołania programów tar i gzip.
