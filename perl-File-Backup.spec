...
Source:		ftp://ftp.perl.org/pub/CPAN/modules/by-module/File/File-Backup-%{version}.tar.gz
...
(
  cd $RPM_BUILD_ROOT%{perl_sitearch}/auto/File/Backup
...
%{perl_sitearch}/auto/File/Backup
